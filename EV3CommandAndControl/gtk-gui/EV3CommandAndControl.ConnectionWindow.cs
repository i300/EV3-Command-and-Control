...
namespace EV3CommandAndControl
{
	public partial class ConnectionWindow
	{
		...
		protected virtual void Build()
		{
			...
			// Widget EV3CommandAndControl.ConnectionWindow
			this.Name = "EV3CommandAndControl.ConnectionWindow";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child EV3CommandAndControl.ConnectionWindow.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child EV3CommandAndControl.ConnectionWindow.ActionArea
